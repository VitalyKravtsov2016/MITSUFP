...
; Lcalization params
Source: "Res\Locales\ru\locale.ini"; DestDir: "{userappdata}\SHTRIH-M\DrvFR"; DestName: "locale.ini"; Flags: 64bit; Components: main; Languages: ru
Source: "Res\Locales\en\locale.ini"; DestDir: "{userappdata}\SHTRIH-M\DrvFR"; DestName: "locale.ini"; Flags: 64bit; Components: main; Languages: en
; VCL70
;Source: "res\vcl70.bpl"; DestDir: "{sys}"; Flags: onlyifdoesntexist sharedfile 64bit;
;Source: "res\rtl70.bpl"; DestDir: "{sys}"; Flags: onlyifdoesntexist sharedfile 64bit;
;Source: "res\BORLNDMM.DLL"; DestDir: "{sys}"; Flags: onlyifdoesntexist sharedfile 64bit;
;SQLite
Source: "res\Win64\sqlite3.dll"; DestDir: "{app}\Bin"; Flags: 64bit; Components: main
;kktproxy
Source: "Bin\Win32\kktproxy.exe"; DestDir: "{app}\Bin\kktproxy"; Flags: sharedfile 64bit; Components: kktproxy
Source: "res\kktproxy.ini"; DestDir: "{app}\Bin\kktproxy"; Flags: onlyifdoesntexist 64bit; Components: kktproxy

;pppnetservice
Source: "Bin\Win32\pppnetsvc.exe"; DestDir: "{app}\Bin\pppnetservice"; Flags: sharedfile 64bit; Components: pppnetservice
Source: "res\pppnetsvc.ini"; DestDir: "{app}\Bin\pppnetservice"; Flags: onlyifdoesntexist 64bit; Components: pppnetservice
Source: "res\Win64\kktnetd.dll"; DestDir: "{app}\Bin\pppnetservice"; Flags: 64bit; Components: pppnetservice

; Driver and test
Source: "Bin\Win64\DrvFR.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion regserver 64bit; Components: main
Source: "Bin\Win64\DrvFRTst.exe"; DestDir: "{app}\Bin"; Flags: ignoreversion 64bit; Components: main
Source: "Bin\Win64\SrvFR.exe"; DestDir: "{app}\Bin"; Flags: ignoreversion 64bit; Components: main
...
;Source: "Bin\SMDrvFR1CLib.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion regserver 64bit; Components: main
;Source: "Bin\SMDrvFR1CLib24.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion regserver 64bit; Components: main
;Source: "Bin\SMDrvFR1CNative.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion 64bit; Components: main
;Source: "..\..\Source\DrvFR\DrvFR.lic"; DestDir: "{app}\Bin"; Flags: 64bit; Components: main


;Source: "Bin\TaxProg.exe"; DestDir: "{app}\Bin"; Flags: ignoreversion 64bit; Components: main
;Source: "Bin\TaxProg2.exe"; DestDir: "{app}\Bin"; Flags: ignoreversion 64bit; Components: main
;Source: "Bin\ServiceProg.exe"; DestDir: "{app}\Bin"; Flags: ignoreversion 64bit; Components: main

;Source: "Bin\DrvFRTst1C.exe"; DestDir: "{app}\Bin"; Flags: ignoreversion 64bit; Components: main
;Source: "res\1C\shtrih-m_15.zip"; DestDir: "{app}\Bin\1C"; Flags: ignoreversion 64bit; Components: main
;Source: "res\1C\20\shtrih-m_20.zip"; DestDir: "{app}\Bin\1C"; Flags: ignoreversion 64bit; Components: main
;Source: "res\1C\22\shtrih-m_22.zip"; DestDir: "{app}\Bin\1C"; Flags: ignoreversion 64bit; Components: main
;Source: "res\1C\24\shtrih-m_25.zip"; DestDir: "{app}\Bin\1C"; Flags: ignoreversion 64bit; Components: main

; OpenSSL
Source: "res\Win64\libeay32.dll"; DestDir: "{app}\Bin"; Flags: 64bit; Components: main
Source: "res\Win64\ssleay32.dll"; DestDir: "{app}\Bin"; Flags: 64bit; Components: main

; Fonts
Source: "res\Fonts\*"; DestDir: "{app}\Fonts"; Components: main

; PPP
;Source: "res\Win64\kktnetd.dll"; DestDir: "{app}\Bin"; Flags: 64bit; Components: main
;Source: "res\Win64\kktnetd.dll"; DestDir: "{app}\Bin"; Flags: 64bit; Components: main


;Source: "res\Win64\libeay32.dll"; DestDir: "{win}\System32"; Flags: onlyifdoesntexist sharedfile 64bit; Components: main
;Source: "res\Win64\ssleay32.dll"; DestDir: "{win}\System32"; Flags: onlyifdoesntexist sharedfile 64bit; Components: main

;Source: "res\Win64\libeay32.dll"; DestDir: "{win}\SysWOW64"; Flags: onlyifdoesntexist sharedfile 64bit; Components: main
;Source: "res\Win64\ssleay32.dll"; DestDir: "{win}\SysWOW64"; Flags: onlyifdoesntexist sharedfile 64bit; Components: main


;FiscalMaster
Source: "Bin\Win64\FiscalMaster.exe"; DestDir: "{app}\Bin"; Flags: ignoreversion 64bit; Components: main
...
; OKassa
Source: "Res\MROK\x32\MROK.exe"; DestDir: "{app}\Bin\OKassa"; Flags: ignoreversion 64bit; Components: okassa; Check: not Is64BitInstallMode
Source: "res\Win64\libeay32.dll"; DestDir: "{app}\Bin\OKassa"; Flags: 64bit; Components: okassa; Check: not Is64BitInstallMode
Source: "res\Win64\ssleay32.dll"; DestDir: "{app}\Bin\OKassa"; Flags: 64bit; Components: okassa; Check: not Is64BitInstallMode

Source: "Res\MROK\x64\MROKx64.exe"; DestDir: "{app}\Bin\OKassa"; Flags: ignoreversion 64bit; Components: okassa; Check: Is64BitInstallMode
Source: "res\Win64\libeay32.dll"; DestDir: "{app}\Bin\OKassa"; Flags: 64bit; Components: okassa; Check: Is64BitInstallMode
Source: "res\Win64\ssleay32.dll"; DestDir: "{app}\Bin\OKassa"; Flags: 64bit; Components: okassa; Check: Is64BitInstallMode

Source: "Res\DrvFR.lic"; DestDir: "{app}\Bin"; Flags: 64bit; Components: main
;Source: "Res\OKassa\OKassaMaster.exe"; DestDir: "{app}\Bin\OKassa"; Flags: ignoreversion 64bit; Components: okassa
;Source: "Res\OKassa\Doc\*"; DestDir: "{app}\Bin\OKassa\Doc"; Flags: recursesubdirs createallsubdirs; Components: okassa
; Payment system
;Source: "Bin\PaymentDrv.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion regserver 64bit; Components: main
;Source: "Res\PaymentDrv.xml"; DestDir: "{app}\Bin"; Flags: 64bit; Components: main
; Models
Source: "Res\Models.xml"; DestDir: "{app}\Bin"; Flags: 64bit; Components: main
Source: "Res\TextMap.xml"; DestDir: "{app}\Bin"; Flags: 64bit; Components: main
Source: "Res\Languages\*"; DestDir: "{app}\Bin\Languages\"; Flags: 64bit; Components: main
; Escape library
;Source: "Res\Escape.dll"; DestDir: "{sys}"; Flags: 64bit
; Samples
Source: "..\..\Samples\*"; DestDir: "{app}\Samples"; Flags: recursesubdirs createallsubdirs 64bit; Components: Samples;
; Samples - 1C version 7.5
;Source: "Bin\DrvFR.dll"; DestDir: "{app}\Samples\1C\1C 7.5"; Flags: ignoreversion 64bit; Components: Samples
;Source: "..\..\Source\DrvFR\DrvFR.lic"; DestDir: "{app}\Samples\1C\1C 7.5"; Flags: 64bit; Components: Samples
;Source: "Res\Models.xml"; DestDir: "{app}\Samples\1C\1C 7.5"; Flags: 64bit; Components: Samples
; Samples - 1C version 7.7
;Source: "Bin\DrvFR.dll"; DestDir: "{app}\Samples\1C\1C 7.7"; Flags: ignoreversion 64bit; Components: Samples
;Source: "..\..\Source\DrvFR\DrvFR.lic"; DestDir: "{app}\Samples\1C\1C 7.7"; Flags: 64bit; Components: Samples
;Source: "Res\Models.xml"; DestDir: "{app}\Samples\1C\1C 7.7"; Flags: 64bit; Components: Samples
; Images
Source: "Res\Images\Logo.bmp"; DestDir: "{app}\Images\"; Flags: 64bit; Components: images
Source: "Res\Images\Testpic_50x50.bmp"; DestDir: "{app}\Images\"; Flags: 64bit; Components: images
Source: "Res\Images\Testpic_100x100.bmp"; DestDir: "{app}\Images\"; Flags: 64bit; Components: images
Source: "Res\Images\Black_320x1200.bmp"; DestDir: "{app}\Images\"; Flags: 64bit; Components: images
; Locales
Source: "..\..\Bin\Win32\Release\locale\en\LC_MESSAGES\DrvFR.mo"; DestDir: "{app}\Bin\locale\en\LC_MESSAGES\"; Flags: 64bit; Components: main
Source: "..\..\Bin\Win32\Release\locale\en\LC_MESSAGES\DrvFRTst.mo"; DestDir: "{app}\Bin\locale\en\LC_MESSAGES\"; Flags: 64bit; Components: main
; DFU drivers
Source: "Res\DFU\Driver\*"; DestDir: "{app}\Bin\DFU\Driver"; Flags: recursesubdirs createallsubdirs 64bit; Components: usbdrivers; AfterInstall: InstallDrivers
Source: "Res\DFU\Util\*"; DestDir: "{app}\Bin\DFU\Util"; Flags: recursesubdirs createallsubdirs 64bit; Components: main 
; usb drivers
Source: "Res\Drivers\*"; DestDir: "{app}\Bin\Drivers"; Flags: recursesubdirs createallsubdirs 64bit; Components: usbdrivers; AfterInstall: InstallDrivers
[Icons]
; Version history
Name: "{group}\{cm:VersionHistory}"; Filename: "{app}\History.txt"; Components: main
; Main
Name: "{group}\{cm:DriverTest} 5.17 (64-bit)"; Filename: "{app}\Bin\DrvFRTst.exe"; WorkingDir: "{app}\Bin"; Components: main
;Name: "{group}\{cm:DriverTest1C} 5.17"; Filename: "{app}\Bin\DrvFRTst1C.exe"; WorkingDir: "{app}\Bin"; Components: main
;Name: "{group}\{cm:ServiceProg}"; Filename: "{app}\Bin\ServiceProg.exe"; WorkingDir: "{app}\Bin"; Components: main
Name: "{group}\{cm:FiscalMaster} 5.17 (64-bit)"; Filename: "{app}\Bin\FiscalMaster.exe"; WorkingDir: "{app}\Bin"; Components: main
;Name: "{group}\{cm:TaxProg2}"; Filename: "{app}\Bin\TaxProg2.exe"; WorkingDir: "{app}\Bin"; Components: main
Name: "{group}\{cm:ServerFR} 5.17 (64-bit)"; Filename: "{app}\Bin\SrvFR.exe"; WorkingDir: "{app}\Bin"; Components: main
...
Name: "{userdesktop}\{cm:FiscalMaster} 5.17 (64-bit)"; Filename: "{app}\Bin\FiscalMaster.exe"; Tasks: desktopicon
...
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\{cm:FiscalMaster} 5.17 (64-bit)"; Filename: "{app}\Bin\FiscalMaster.exe"; Tasks: quicklaunchicon
...
; Driver version
Root: HKCU; Subkey: "Software\ShtrihM\DrvFR\Param"; ValueType: string; ValueName: "DriverVersion"; ValueData: "5.17.0.989"; Flags: uninsdeletevalue
