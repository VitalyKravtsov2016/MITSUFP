...
// PASTLWTR : 1.2
// File generated on 27.05.2024 12:25:50 from Type Library described below.

// ************************************************************************  //
// Type Lib: D:\projects\MITSUFP\Src\MitsuDrv1C\MitsuDrv1C.tlb (1)
// LIBID: {6FE83C54-4C5A-48CC-A873-090A627CCAAD}
// LCID: 0
// Helpfile:
...
const
  ...
  LIBID_MitsuLib: TGUID = '{6FE83C54-4C5A-48CC-A873-090A627CCAAD}';

  IID_IDrvFR1C: TGUID = '{67F607AD-6F55-494F-82E4-9B7199EE0D7B}';
...
type
  ...
  // GUID:      {67F607AD-6F55-494F-82E4-9B7199EE0D7B}
  // *********************************************************************//
  IDrvFR1C = interface(IDispatch)
    ['{67F607AD-6F55-494F-82E4-9B7199EE0D7B}']
    ...
    function CashInOutcome(const DeviceID: WideString; Amount: Double)
      : WordBool; safecall;
    ...
    function PrintFiscalString(const DeviceID: WideString;
      const Name: WideString; Quantity: Double; Price: Double; Amount: Double;
      Department: Integer; Tax: Single): WordBool; safecall;
    function CloseCheck(const DeviceID: WideString; Cash: Double;
      PayByCard: Double; PayByCredit: Double): WordBool; safecall;
    function CancelCheck(const DeviceID: WideString): WordBool; safecall;
    function PrintNonFiscalString(const DeviceID: WideString;
      const TextString: WideString): WordBool; safecall;
    function DeviceTest(const ValuesArray: IDispatch;
      out AdditionalDescription: WideString): WordBool; safecall;
    function Open(const ValuesArray: IDispatch; out DeviceID: WideString)
      : WordBool; safecall;
    ...
    function OpenCashDrawer(const DeviceID: WideString; CashDrawerID: Integer)
      : WordBool; safecall;
    function LoadLogo(const ValuesArray: IDispatch;
      const LogoFileName: WideString; CenterLogo: WordBool;
      out LogoSize: Integer; out AdditionalDescription: WideString)
      : WordBool; safecall;
    ...
    function DeviceControlHEX(const DeviceID: WideString;
      const TxData: WideString; out RxData: WideString): WordBool; safecall;
    ...
    property DiscountOnCheck: Double read Get_DiscountOnCheck
      write Set_DiscountOnCheck;
  ...
  IDrvFR1CDisp = dispinterface
    ...
    function CloseCheck(const DeviceID: WideString; Cash: Double;
      PayByCard: Double; PayByCredit: Double): WordBool; dispid 210;
    function CancelCheck(const DeviceID: WideString): WordBool; dispid 211;
    function PrintNonFiscalString(const DeviceID: WideString;
      const TextString: WideString): WordBool; dispid 212;
    function DeviceTest(const ValuesArray: IDispatch;
      out AdditionalDescription: WideString): WordBool; dispid 213;
    function Open(const ValuesArray: IDispatch; out DeviceID: WideString)
      : WordBool; dispid 203;
    function CheckPrintingStatus(const DeviceID: WideString): WordBool;
      dispid 214;
    ...
    function DeviceControlHEX(const DeviceID: WideString;
      const TxData: WideString; out RxData: WideString): WordBool; dispid 220;
  ...
  IDrvFR1C11 = interface(IDispatch)
    ...
    function PrintNonFiscalString(const DeviceID: WideString;
      const TextString: WideString): WordBool; safecall;
    function PrintBarCode(const DeviceID: WideString;
      const BarcodeType: WideString; const BarCode: WideString)
      : WordBool; safecall;
    function CloseCheck(const DeviceID: WideString; Cash: Double;
      PayByCard: Double; PayByCredit: Double; PayByCertificate: Double)
      : WordBool; safecall;
    function CancelCheck(const DeviceID: WideString): WordBool; safecall;
    function CashInOutcome(const DeviceID: WideString; Amount: Double)
      : WordBool; safecall;
    ...
    function PrintFiscalString2(const DeviceID: WideString;
      const Name: WideString; Quantity: Double; Price: Double; Amount: Double;
  ...
  IDrvFR1C11Disp = dispinterface
    ...
    function DeviceTest(out Description: WideString;
      out DemoModeIsActivated: WideString): WordBool; dispid 208;
    ...
    function PrintNonFiscalString(const DeviceID: WideString;
      const TextString: WideString): WordBool; dispid 213;
    function PrintBarCode(const DeviceID: WideString;
      const BarcodeType: WideString; const BarCode: WideString): WordBool;
      dispid 214;
    function CloseCheck(const DeviceID: WideString; Cash: Double;
      PayByCard: Double; PayByCredit: Double; PayByCertificate: Double)
      : WordBool; dispid 215;
    ...
    function CheckPrintingStatus(const DeviceID: WideString): WordBool;
      dispid 226;
    function DeviceControlHEX(const DeviceID: WideString;
      const TxData: WideString; out RxData: WideString): WordBool; dispid 227;
  end;
  ...
  IDrvFR1C17 = interface(IDispatch)
    ...
    function OperationFN(const DeviceID: WideString; OperationType: Integer;
      const CashierName: WideString; const ParametersFiscal: WideString)
      : WordBool; safecall;
    function OpenShift(const DeviceID: WideString;
      const CashierName: WideString; out SessionNumber: Integer;
    ...
    function ProcessCorrectionCheck(const DeviceID: WideString;
      const CashierName: WideString; const CheckCorrectionPackage: WideString;
      out CheckNumber: Integer; out SessionNumber: Integer;
      out FiscalSign: WideString; out AddressSiteInspections: WideString)
      : WordBool; safecall;
    function CashInOutcome(const DeviceID: WideString; Amount: Double)
      : WordBool; safecall;
    function GetCurrentStatus(const DeviceID: WideString;
      out CheckNumber: Integer; out SessionNumber: Integer;
      out SessionState: Integer; out StatusParameters: WideString)
      : WordBool; safecall;
  ...
  IDrvFR1C17Disp = dispinterface
    ...
    function DoAdditionalAction(const ActionName: WideString): WordBool;
      dispid 210;
    function GetDataKKT(const DeviceID: WideString;
      out TableParametersKKT: WideString): WordBool; dispid 211;
    function OperationFN(const DeviceID: WideString; OperationType: Integer;
      const CashierName: WideString; const ParametersFiscal: WideString)
      : WordBool; dispid 212;
    function OpenShift(const DeviceID: WideString;
    ...
    function GetCurrentStatus(const DeviceID: WideString;
      out CheckNumber: Integer; out SessionNumber: Integer;
      out SessionState: Integer; out StatusParameters: WideString): WordBool;
      dispid 218;
    function ReportCurrentStatusOfSettlements(const DeviceID: WideString)
      : WordBool; dispid 219;
    function OpenCashDrawer(const DeviceID: WideString): WordBool; dispid 220;
    function GetLineLength(const DeviceID: WideString; out LineLength: Integer)
      : WordBool; dispid 221;
    function PrintTextDocument(const DeviceID: WideString;
      const DocumentPackage: WideString): WordBool; dispid 222;
  ...
  IDrvFR1C22 = interface(IDispatch)
    ...
    function OpenShift(const DeviceID: WideString;
      ...
      out SessionNumber: Integer; out DocumentNumber: Integer)
      : WordBool; safecall;
    function CloseShift(const DeviceID: WideString;
      const InputParameters: WideString; out OutputParameters: WideString;
      out SessionNumber: Integer; out DocumentNumber: Integer)
    ...
    function ProcessCheck(const DeviceID: WideString; Electronically: WordBool;
      ...
      out AddressSiteInspections: WideString): WordBool; safecall;
    function ProcessCorrectionCheck(const DeviceID: WideString;
      const CheckCorrectionPackage: WideString; out CheckNumber: Integer;
      out SessionNumber: Integer; out FiscalSign: WideString;
      out AddressSiteInspections: WideString): WordBool; safecall;
    function PrintTextDocument(const DeviceID: WideString;
      const DocumentPackage: WideString): WordBool; safecall;
  ...
  IDrvFR1C22Disp = dispinterface
    ...
    function PrintTextDocument(const DeviceID: WideString;
      const DocumentPackage: WideString): WordBool; dispid 217;
    function CashInOutcome(const DeviceID: WideString;
      const InputParameters: WideString; Amount: Double): WordBool; dispid 218;
    function PrintXReport(const DeviceID: WideString;
      const InputParameters: WideString): WordBool; dispid 219;
    function GetCurrentStatus(const DeviceID: WideString;
      out CheckNumber: Integer; out SessionNumber: Integer;
      out SessionState: Integer; out StatusParameters: WideString): WordBool;
      dispid 220;
  ...
  IDrvFR1C30Disp = dispinterface
    ...
    function GetLineLength(const DeviceID: WideString; out LineLength: Integer)
      : WordBool; dispid 223;
    function PrintCheckCopy(const DeviceID: WideString;
      const CheckNumber: WideString): WordBool; dispid 224;
    function PrintTextDocument(const DeviceID: WideString;
      const DocumentPackage: WideString): WordBool; dispid 225;
    ...
    function GetLocalizationPattern(out LocalizationPattern: WideString)
      : WordBool; dispid 231;
    function SetLocalization(const LanguageCode: WideString;
      const LocalizationPattern: WideString): WordBool; dispid 232;
  end;
  ...
  public
    ...
    function CloseCheck(const DeviceID: WideString; Cash: Double;
      PayByCard: Double; PayByCredit: Double): WordBool;
    function CancelCheck(const DeviceID: WideString): WordBool;
    function PrintNonFiscalString(const DeviceID: WideString;
      const TextString: WideString): WordBool;
    function DeviceTest(const ValuesArray: IDispatch;
    ...
    function DeviceControlHEX(const DeviceID: WideString;
      const TxData: WideString; out RxData: WideString): WordBool;
    property ControlInterface: IDrvFR1C read GetControlInterface;
    property DefaultInterface: IDrvFR1C read GetControlInterface;
  published
    property Anchors;
    property DiscountOnCheck: Double index 221 read GetDoubleProp
      write SetDoubleProp stored False;
    property PayType4: Double index 222 read GetDoubleProp write SetDoubleProp
      stored False;
  end;
  ...
  published
    property Anchors;
    property sm_FormatVersion: Integer index 217 read GetIntegerProp
...
const
  CControlData: TControlData2 = (ClassID
    : '{129C1D7A-384D-4CD6-9F28-7CF321FF9D04}'; EventIID: ''; EventCount: 0;
    EventDispIDs: nil; LicenseKey: nil (* HR:$00000000 *); Flags: $00000000;
    Version: 401);
begin
...
function TDrvFR1C.CashInOutcome(const DeviceID: WideString; Amount: Double)
  : WordBool;
begin
...
function TDrvFR1C.OpenCheck(const DeviceID: WideString; IsFiscalCheck: WordBool;
  ...
  out CheckNumber: Integer; out SessionNumber: Integer): WordBool;
begin
  Result := DefaultInterface.OpenCheck(DeviceID, IsFiscalCheck, IsReturnCheck,
    CancelOpenedCheck, CheckNumber, SessionNumber);
end;

function TDrvFR1C.PrintFiscalString(const DeviceID: WideString;
  const Name: WideString; Quantity: Double; Price: Double; Amount: Double;
  Department: Integer; Tax: Single): WordBool;
begin
  Result := DefaultInterface.PrintFiscalString(DeviceID, Name, Quantity, Price,
    Amount, Department, Tax);
end;

function TDrvFR1C.CloseCheck(const DeviceID: WideString; Cash: Double;
  PayByCard: Double; PayByCredit: Double): WordBool;
begin
...
function TDrvFR1C.PrintNonFiscalString(const DeviceID: WideString;
  const TextString: WideString): WordBool;
begin
...
function TDrvFR1C.Open(const ValuesArray: IDispatch; out DeviceID: WideString)
  : WordBool;
begin
...
function TDrvFR1C.LoadLogo(const ValuesArray: IDispatch;
  const LogoFileName: WideString; CenterLogo: WordBool; out LogoSize: Integer;
  out AdditionalDescription: WideString): WordBool;
begin
  Result := DefaultInterface.LoadLogo(ValuesArray, LogoFileName, CenterLogo,
...
function TDrvFR1C.DeviceControl(const DeviceID: WideString;
  const TxData: WideString; out RxData: WideString): WordBool;
begin
  Result := DefaultInterface.DeviceControl(DeviceID, TxData, RxData);
end;

function TDrvFR1C.DeviceControlHEX(const DeviceID: WideString;
  const TxData: WideString; out RxData: WideString): WordBool;
begin
...
const
  CControlData: TControlData2 = (ClassID
    : '{44809D9F-9A23-4CDD-A4CC-39A052C3BDFB}'; EventIID: ''; EventCount: 0;
    EventDispIDs: nil; LicenseKey: nil (* HR:$00000000 *); Flags: $00000000;
    Version: 401);
begin
  ControlData := @CControlData;
...
function TDrvFR1C11.GetDescription(out Name: WideString;
  out Description: WideString; out EquipmentType: WideString;
  out InterfaceRevision: Integer; out IntegrationLibrary: WordBool;
  out MainDriverInstalled: WordBool; out GetDownloadURL: WideString): WordBool;
begin
  Result := DefaultInterface.GetDescription(Name, Description, EquipmentType,
...
function TDrvFR1C11.SetParameter(const Name: WideString; Value: OleVariant)
  : WordBool;
begin
...
function TDrvFR1C11.DeviceTest(out Description: WideString;
  out DemoModeIsActivated: WideString): WordBool;
begin
  Result := DefaultInterface.DeviceTest(Description, DemoModeIsActivated);
end;

function TDrvFR1C11.GetAdditionalActions(out TableActions: WideString)
  : WordBool;
begin
...
function TDrvFR1C11.OpenCheck(const DeviceID: WideString;
  IsFiscalCheck: WordBool; IsReturnCheck: WordBool; CancelOpenedCheck: WordBool;
  out CheckNumber: Integer; out SessionNumber: Integer): WordBool;
begin
  Result := DefaultInterface.OpenCheck(DeviceID, IsFiscalCheck, IsReturnCheck,
    CancelOpenedCheck, CheckNumber, SessionNumber);
...
function TDrvFR1C11.PrintFiscalString(const DeviceID: WideString;
  const Name: WideString; Quantity: Double; Price: Double; Amount: Double;
  Department: Integer; Tax: Double): WordBool;
begin
  Result := DefaultInterface.PrintFiscalString(DeviceID, Name, Quantity, Price,
...
function TDrvFR1C11.PrintNonFiscalString(const DeviceID: WideString;
  const TextString: WideString): WordBool;
begin
  Result := DefaultInterface.PrintNonFiscalString(DeviceID, TextString);
end;

function TDrvFR1C11.PrintBarCode(const DeviceID: WideString;
  const BarcodeType: WideString; const BarCode: WideString): WordBool;
begin
  Result := DefaultInterface.PrintBarCode(DeviceID, BarcodeType, BarCode);
end;

function TDrvFR1C11.CloseCheck(const DeviceID: WideString; Cash: Double;
  PayByCard: Double; PayByCredit: Double; PayByCertificate: Double): WordBool;
begin
  Result := DefaultInterface.CloseCheck(DeviceID, Cash, PayByCard, PayByCredit,
    PayByCertificate);
end;
...
function TDrvFR1C11.CashInOutcome(const DeviceID: WideString; Amount: Double)
  : WordBool;
begin
  Result := DefaultInterface.CashInOutcome(DeviceID, Amount);
end;
...
function TDrvFR1C11.PrintFiscalString2(const DeviceID: WideString;
  const Name: WideString; Quantity: Double; Price: Double; Amount: Double;
  Department: Integer; Tax1: Integer; Tax2: Integer; Tax3: Integer;
  Tax4: Integer): WordBool;
begin
  Result := DefaultInterface.PrintFiscalString2(DeviceID, Name, Quantity, Price,
    Amount, Department, Tax1, Tax2, Tax3, Tax4);
end;
...
function TDrvFR1C11.DeviceControlHEX(const DeviceID: WideString;
  const TxData: WideString; out RxData: WideString): WordBool;
begin
  Result := DefaultInterface.DeviceControlHEX(DeviceID, TxData, RxData);
end;
...
const
  CControlData: TControlData2 = (ClassID
    : '{6A751D33-0AAB-4339-BCC4-8056B3FC87F4}'; EventIID: ''; EventCount: 0;
    EventDispIDs: nil; LicenseKey: nil (* HR:$00000000 *); Flags: $00000000;
    Version: 401);
begin
  ControlData := @CControlData;
...
function TDrvFR1C17.GetDescription(out Name: WideString;
  out Description: WideString; out EquipmentType: WideString;
  out InterfaceRevision: Integer; out IntegrationLibrary: WordBool;
...
function TDrvFR1C17.SetParameter(const Name: WideString; Value: OleVariant)
  : WordBool;
begin
  Result := DefaultInterface.SetParameter(Name, Value);
end;
...
function TDrvFR1C17.DeviceTest(out Description: WideString;
  out DemoModeIsActivated: WideString): WordBool;
begin
  Result := DefaultInterface.DeviceTest(Description, DemoModeIsActivated);
end;

function TDrvFR1C17.GetAdditionalActions(out TableActions: WideString)
  : WordBool;
begin
  Result := DefaultInterface.GetAdditionalActions(TableActions);
end;
...
function TDrvFR1C17.OperationFN(const DeviceID: WideString;
  ...
  const ParametersFiscal: WideString): WordBool;
begin
  Result := DefaultInterface.OperationFN(DeviceID, OperationType, CashierName,
    ParametersFiscal);
end;

function TDrvFR1C17.OpenShift(const DeviceID: WideString;
  const CashierName: WideString; out SessionNumber: Integer;
  out DocumentNumber: Integer): WordBool;
begin
  Result := DefaultInterface.OpenShift(DeviceID, CashierName, SessionNumber,
    DocumentNumber);
end;

function TDrvFR1C17.CloseShift(const DeviceID: WideString;
  const CashierName: WideString; out SessionNumber: Integer;
  out DocumentNumber: Integer): WordBool;
begin
  Result := DefaultInterface.CloseShift(DeviceID, CashierName, SessionNumber,
    DocumentNumber);
end;

function TDrvFR1C17.ProcessCheck(const DeviceID: WideString;
  const CashierName: WideString; Electronically: WordBool;
  const CheckPackage: WideString; out CheckNumber: Integer;
  out SessionNumber: Integer; out FiscalSign: WideString;
  out AddressSiteInspections: WideString): WordBool;
begin
  Result := DefaultInterface.ProcessCheck(DeviceID, CashierName, Electronically,
    CheckPackage, CheckNumber, SessionNumber, FiscalSign,
...
begin
  Result := DefaultInterface.ProcessCorrectionCheck(DeviceID, CashierName,
    CheckCorrectionPackage, CheckNumber, SessionNumber, FiscalSign,
    AddressSiteInspections);
end;

function TDrvFR1C17.CashInOutcome(const DeviceID: WideString; Amount: Double)
  : WordBool;
begin
  Result := DefaultInterface.CashInOutcome(DeviceID, Amount);
end;
...
function TDrvFR1C17.GetCurrentStatus(const DeviceID: WideString;
  ...
  out SessionState: Integer; out StatusParameters: WideString): WordBool;
begin
  Result := DefaultInterface.GetCurrentStatus(DeviceID, CheckNumber,
    SessionNumber, SessionState, StatusParameters);
end;

function TDrvFR1C17.ReportCurrentStatusOfSettlements(const DeviceID: WideString)
  : WordBool;
begin
...
function TDrvFR1C17.PrintTextDocument(const DeviceID: WideString;
  const DocumentPackage: WideString): WordBool;
begin
...
const
  CControlData: TControlData2 = (ClassID
    : '{E5903D73-66CC-42D7-9647-DBD2C837D8A7}'; EventIID: ''; EventCount: 0;
    EventDispIDs: nil; LicenseKey: nil (* HR:$00000000 *); Flags: $00000000;
    Version: 401);
begin
  ControlData := @CControlData;
...
function TDrvFR1C22.GetDescription(out Name: WideString;
  out Description: WideString; out EquipmentType: WideString;
  out InterfaceRevision: Integer; out IntegrationLibrary: WordBool;
  out MainDriverInstalled: WordBool; out DownloadURL: WideString): WordBool;
begin
...
function TDrvFR1C22.SetParameter(const Name: WideString; Value: OleVariant)
  : WordBool;
begin
  Result := DefaultInterface.SetParameter(Name, Value);
end;
...
function TDrvFR1C22.DeviceTest(out Description: WideString;
  out DemoModeIsActivated: WideString): WordBool;
begin
  Result := DefaultInterface.DeviceTest(Description, DemoModeIsActivated);
end;

function TDrvFR1C22.GetAdditionalActions(out TableActions: WideString)
  : WordBool;
begin
  Result := DefaultInterface.GetAdditionalActions(TableActions);
end;
...
begin
  Result := DefaultInterface.OperationFN(DeviceID, OperationType,
    ParametersFiscal);
end;

function TDrvFR1C22.OpenShift(const DeviceID: WideString;
  const InputParameters: WideString; out OutputParameters: WideString;
  out SessionNumber: Integer; out DocumentNumber: Integer): WordBool;
begin
  Result := DefaultInterface.OpenShift(DeviceID, InputParameters,
    OutputParameters, SessionNumber, DocumentNumber);
end;

function TDrvFR1C22.CloseShift(const DeviceID: WideString;
  const InputParameters: WideString; out OutputParameters: WideString;
  out SessionNumber: Integer; out DocumentNumber: Integer): WordBool;
begin
  Result := DefaultInterface.CloseShift(DeviceID, InputParameters,
    OutputParameters, SessionNumber, DocumentNumber);
end;
...
function TDrvFR1C22.ProcessCheck(const DeviceID: WideString;
  ...
  out FiscalSign: WideString; out AddressSiteInspections: WideString): WordBool;
begin
  Result := DefaultInterface.ProcessCheck(DeviceID, Electronically,
    CheckPackage, CheckNumber, SessionNumber, FiscalSign,
    AddressSiteInspections);
end;
...
function TDrvFR1C22.ProcessCorrectionCheck(const DeviceID: WideString;
  ...
  out AddressSiteInspections: WideString): WordBool;
begin
  Result := DefaultInterface.ProcessCorrectionCheck(DeviceID,
    CheckCorrectionPackage, CheckNumber, SessionNumber, FiscalSign,
    AddressSiteInspections);
end;

function TDrvFR1C22.PrintTextDocument(const DeviceID: WideString;
  const DocumentPackage: WideString): WordBool;
begin
  Result := DefaultInterface.PrintTextDocument(DeviceID, DocumentPackage);
end;

function TDrvFR1C22.CashInOutcome(const DeviceID: WideString;
  const InputParameters: WideString; Amount: Double): WordBool;
begin
  Result := DefaultInterface.CashInOutcome(DeviceID, InputParameters, Amount);
end;

function TDrvFR1C22.PrintXReport(const DeviceID: WideString;
  const InputParameters: WideString): WordBool;
begin
...
const
  CControlData: TControlData2 = (ClassID
    : '{32D32C7A-CEF9-4AC5-8953-3D6DF81ABBD6}'; EventIID: ''; EventCount: 0;
    EventDispIDs: nil; LicenseKey: nil (* HR:$00000000 *); Flags: $00000000;
    Version: 401);
begin
  ControlData := @CControlData;
...
function TDrvFR1C30.OpenShift(const DeviceID: WideString;
  const InputParameters: WideString; out OutputParameters: WideString)
  : WordBool;
begin
  Result := DefaultInterface.OpenShift(DeviceID, InputParameters,
...
function TDrvFR1C30.CloseShift(const DeviceID: WideString;
  const InputParameters: WideString; out OutputParameters: WideString)
  : WordBool;
begin
  Result := DefaultInterface.CloseShift(DeviceID, InputParameters,
...
begin
  Result := DefaultInterface.ProcessCheck(DeviceID, Electronically,
    CheckPackage, DocumentOutputParameters);
end;
...
function TDrvFR1C30.ProcessCorrectionCheck(const DeviceID: WideString;
  ...
  : WordBool;
begin
  Result := DefaultInterface.ProcessCorrectionCheck(DeviceID, CheckPackage,
    DocumentOutputParameters);
end;

function TDrvFR1C30.CashInOutcome(const DeviceID: WideString;
  const InputParameters: WideString; Amount: Double): WordBool;
begin
  Result := DefaultInterface.CashInOutcome(DeviceID, InputParameters, Amount);
end;

function TDrvFR1C30.PrintXReport(const DeviceID: WideString;
  const InputParameters: WideString): WordBool;
begin
  Result := DefaultInterface.PrintXReport(DeviceID, InputParameters);
end;

function TDrvFR1C30.GetCurrentStatus(const DeviceID: WideString;
  const InputParameters: WideString; out OutputParameters: WideString)
  : WordBool;
begin
  Result := DefaultInterface.GetCurrentStatus(DeviceID, InputParameters,
    OutputParameters);
end;
...
function TDrvFR1C30.PrintCheckCopy(const DeviceID: WideString;
  const CheckNumber: WideString): WordBool;
begin
  Result := DefaultInterface.PrintCheckCopy(DeviceID, CheckNumber);
end;

function TDrvFR1C30.PrintTextDocument(const DeviceID: WideString;
  const DocumentPackage: WideString): WordBool;
begin
  Result := DefaultInterface.PrintTextDocument(DeviceID, DocumentPackage);
end;
...
function TDrvFR1C30.RequestKM(const DeviceID: WideString;
  const RequestKM: WideString; out RequestKMResult: WideString): WordBool;
begin
...
function TDrvFR1C30.GetProcessingKMResult(const DeviceID: WideString;
  out ProcessingKMResult: WideString; out RequestStatus: Integer): WordBool;
begin
  Result := DefaultInterface.GetProcessingKMResult(DeviceID, ProcessingKMResult,
    RequestStatus);
end;

function TDrvFR1C30.ConfirmKM(const DeviceID: WideString;
  const RequestGUID: WideString; ConfirmationType: Integer): WordBool;
begin
