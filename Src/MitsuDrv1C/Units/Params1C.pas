...
function GetIntParamValue(V: Variant; Index: Integer;
...
function ValuesArrayToStr(const AValuesArray: IDispatch;
  AOut: Boolean = False): string;
...
begin
  ...
  sConnectionType := GetIntParamValueAsString(V,
    DRVFR_VALUE_INDEX_CONNECTION_TYPE);
  ...
  Result := 'Port: ' + sPort + '; Speed: ' + sSpeed + '; Userpassword: ' +
    sUserPassword + '; AdminPassword: ' + sAdminPassword + '; Timeout: ' +
    sTimeout + '; Tax1: ' + sTax1 + '; Tax2: ' + sTax2 + '; Tax3: ' + sTax3 +
    '; Tax4: ' + sTax4 + '; CloseSession: ' + sCloseSession + '; EnableLog: ' +
    sEnableLog + '; PayName1: ' + sPayName1 + '; PayName2: ' + sPayName2 +
...
begin
  ...
  Result := 'Port: ' + sPort + '; Speed: ' + sSpeed + '; Userpassword: ' +
    sUserPassword + '; Timeout: ' + sTimeout + '; ConnectionType: ' +
    sConnectionType + '; ComputerName: ' + sComputerName + '; IPAddress: ' +
    sIPAddress + '; TCPPort: ' + sTCPPort;
end;
