...
type
  ...
  TOleMain1C30 = class(TActiveXControl1C, IMitsu1C30)
  private
    FLogger: ILogFile;
    FDriver: TMitsuDrv1C;
...
destructor TOleMain1C30.Destroy;
begin
  FDriver.Free;
  FLogger := nil;
  inherited Destroy;
...
function TOleMain1C30.GetLogFile: ILogFile;
begin
  if FLogger = nil then
  begin
...
function TOleMain1C30.CloseShift(const DeviceID, InputParameters: WideString;
  out OutputParameters: WideString): WordBool;
begin
  Result := Driver.CloseShift(DeviceID, InputParameters, OutputParameters);
end;

function TOleMain1C30.DeviceTest(out Description: WideString;
  out DemoModeIsActivated: WideString): WordBool;
begin
  Result := Driver.DeviceTest(Description, DemoModeIsActivated);
end;

function TOleMain1C30.DoAdditionalAction(const ActionName: WideString): WordBool;
begin
  Result := Driver.DoAdditionalAction(ActionName);
end;

function TOleMain1C30.GetAdditionalActions(out TableActions: WideString)
  : WordBool;
begin
  Result := Driver.GetAdditionalActions(TableActions);
end;

function TOleMain1C30.GetCurrentStatus(const DeviceID, InputParameters
...
function TOleMain1C30.GetDataKKT(const DeviceID: WideString;
  out TableParametersKKT: WideString): WordBool;
begin
  Result := Driver.GetDataKKT(DeviceID, TableParametersKKT);
end;

function TOleMain1C30.GetDescription(out DriverDescription: WideString): WordBool;
begin
...
function TOleMain1C30.GetInterfaceRevision: Integer;
begin
  Result := Driver.GetInterfaceRevision;
end;

function TOleMain1C30.GetLastError(out ErrorDescription: WideString): Integer;
begin
...
function TOleMain1C30.GetLineLength(const DeviceID: WideString;
...
function TOleMain1C30.GetParameters(out TableParameters: WideString): WordBool;
begin
  Result := Driver.GetParameters(TableParameters);
end;

function TOleMain1C30.Open(out DeviceID: WideString): WordBool;
begin
  Result := Driver.Open(DeviceID);
end;

function TOleMain1C30.OpenCashDrawer(const DeviceID: WideString): WordBool;
begin
  Result := Driver.OpenCashDrawer(DeviceID);
end;

function TOleMain1C30.OpenShift(const DeviceID, InputParameters: WideString;
  out OutputParameters: WideString): WordBool;
begin
  Result := Driver.OpenShift(DeviceID, InputParameters, OutputParameters);
end;

function TOleMain1C30.OperationFN(const DeviceID: WideString;
...
function TOleMain1C30.PrintCheckCopy(const DeviceID, CheckNumber: WideString)
  : WordBool;
begin
  Result := Driver.PrintCheckCopy(DeviceID, CheckNumber);
end;

function TOleMain1C30.PrintTextDocument(const DeviceID, DocumentPackage
  : WideString): WordBool;
begin
  Result := Driver.PrintTextDocument(DeviceID, DocumentPackage);
end;

function TOleMain1C30.PrintXReport(const DeviceID, InputParameters: WideString)
  : WordBool;
begin
  Result := Driver.PrintXReport(DeviceID, InputParameters);
end;

function TOleMain1C30.ProcessCheck(const DeviceID: WideString;
...
function TOleMain1C30.ProcessCorrectionCheck(const DeviceID,
...
function TOleMain1C30.ReportCurrentStatusOfSettlements(const DeviceID,
...
procedure TOleMain1C30.SetLang(LangID: Integer);
begin
  if LangID = 0 then
...
function TOleMain1C30.SetParameter(const Name: WideString; Value: OleVariant)
  : WordBool;
begin
  Result := Driver.SetParameter(Name, Value);
end;

function TOleMain1C30.CloseSessionRegistrationKM(const DeviceID: WideString)
  : WordBool;
begin
  Result := Driver.CloseSessionRegistrationKM(DeviceID);
end;

function TOleMain1C30.ConfirmKM(const DeviceID, RequestGUID: WideString;
  ConfirmationType: Integer): WordBool;
begin
  Result := Driver.ConfirmKM(DeviceID, RequestGUID, ConfirmationType);
end;

function TOleMain1C30.Get_sm_FormatVersion: Integer;
begin
  Result := 0;
  // Result := Driver.FormatVersion; !!!
end;

function TOleMain1C30.GetProcessingKMResult(const DeviceID: WideString;
...
function TOleMain1C30.OpenSessionRegistrationKM(const DeviceID: WideString)
  : WordBool;
begin
  Result := Driver.OpenSessionRegistrationKM(DeviceID);
end;

function TOleMain1C30.RequestKM(const DeviceID, RequestKM: WideString;
  out RequestKMResult: WideString): WordBool;
begin
  Result := Driver.RequestKM(DeviceID, RequestKM, RequestKMResult);
end;

procedure TOleMain1C30.Set_sm_FormatVersion(Value: Integer);
begin
  // Driver.FormatVersion := Value; !!!
end;

function TOleMain1C30.GetLocalizationPattern(out LocalizationPattern: WideString)
  : WordBool;
begin
  Result := Driver.GetLocalizationPattern(LocalizationPattern);
end;

function TOleMain1C30.SetLocalization(const LanguageCode, LocalizationPattern
  : WideString): WordBool;
begin
...
TActiveXControlFactory.Create(ComServer, TOleMain1C30, TActiveXView,
