...
uses
  ...
  TestFramework,
  // This
  MitsuLib_TLB, FileUtils, XmlDoc1C;
...
begin
  Driver := CreateOleObject('Addin.Mitsu1C30') as IMitsu1C30;
end;
...
begin
  ...
  CheckEquals('1.0.0.1', Node.Attributes['DriverVersion'], 'DriverVersion');
  CheckEquals('1.0.0.1', Node.Attributes['IntegrationComponentVersion'], 'IntegrationComponentVersion');
...
begin
  ...
  CheckEquals('00h, Ошибок нет', ErrorDescription, 'ErrorDescription');
end;
...
begin
  Driver.SetParameter('ConnectionType', 0);
  Driver.SetParameter('Port', 'COM8');
  Driver.SetParameter('Baudrate', 115200);
  CheckEquals(True, Driver.Open(DeviceID), 'Open');
