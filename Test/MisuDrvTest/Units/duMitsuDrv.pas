...
const
  ...
  Data2 = '<OK TAX=''T1:20%, T2:10%, T3:20/120, T4:10/110, T5:0%, T6:аег мдя''/>';
...
(*
  ...
  CheckEquals('T1:20%, T2:10%, T3:20/120, T4:10/110, T5:0%, T6:аег мдя', Doc.DocumentElement.GetAttributeNS('TAX', ''));
*)
end;
...
// T1:20%, T2:10%, T3:20/120, T4:10/110, T5:0%, T6:аег мдя
// <OK TAX='T1:20%, T2:10%, T3:20/120, T4:10/110, T5:0%, T6:аег мдя'/>
...
begin
  ...
  CheckEquals('ъпся', R.T1046, 'T1046');
